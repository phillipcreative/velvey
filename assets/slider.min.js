!function(t,n){var u,e=t.jQuery||t.Cowboy||(t.Cowboy={});e.throttle=u=function(t,u,o,i){function r(){function e(){c=+new Date,o.apply(f,g)}
	function r(){a=n}
	var f=this,d=+new Date-c,g=arguments;i&&!a&&e(),a&&clearTimeout(a),i===n&&d>t?e():u!==!0&&(a=setTimeout(i?r:e,i===n?t-d:t))}
	var a,c=0;return"boolean"!=typeof u&&(i=o,o=u,u=n),e.guid&&(r.guid=o.guid=o.guid||e.guid++),r},e.debounce=function(t,e,o){return o===n?u(t,e,!1):u(t,o,e!==!1)}}(this);window.mobileCheck=function(){var i=!1;return function(a){(/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|mobile.+firefox|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows ce|xda|xiino/i.test(a)||/1207|6310|6590|3gso|4thp|50[1-6]i|770s|802s|a wa|abac|ac(er|oo|s\-)|ai(ko|rn)|al(av|ca|co)|amoi|an(ex|ny|yw)|aptu|ar(ch|go)|as(te|us)|attw|au(di|\-m|r |s )|avan|be(ck|ll|nq)|bi(lb|rd)|bl(ac|az)|br(e|v)w|bumb|bw\-(n|u)|c55\/|capi|ccwa|cdm\-|cell|chtm|cldc|cmd\-|co(mp|nd)|craw|da(it|ll|ng)|dbte|dc\-s|devi|dica|dmob|do(c|p)o|ds(12|\-d)|el(49|ai)|em(l2|ul)|er(ic|k0)|esl8|ez([4-7]0|os|wa|ze)|fetc|fly(\-|_)|g1 u|g560|gene|gf\-5|g\-mo|go(\.w|od)|gr(ad|un)|haie|hcit|hd\-(m|p|t)|hei\-|hi(pt|ta)|hp( i|ip)|hs\-c|ht(c(\-| |_|a|g|p|s|t)|tp)|hu(aw|tc)|i\-(20|go|ma)|i230|iac( |\-|\/)|ibro|idea|ig01|ikom|im1k|inno|ipaq|iris|ja(t|v)a|jbro|jemu|jigs|kddi|keji|kgt( |\/)|klon|kpt |kwc\-|kyo(c|k)|le(no|xi)|lg( g|\/(k|l|u)|50|54|\-[a-w])|libw|lynx|m1\-w|m3ga|m50\/|ma(te|ui|xo)|mc(01|21|ca)|m\-cr|me(rc|ri)|mi(o8|oa|ts)|mmef|mo(01|02|bi|de|do|t(\-| |o|v)|zz)|mt(50|p1|v )|mwbp|mywa|n10[0-2]|n20[2-3]|n30(0|2)|n50(0|2|5)|n7(0(0|1)|10)|ne((c|m)\-|on|tf|wf|wg|wt)|nok(6|i)|nzph|o2im|op(ti|wv)|oran|owg1|p800|pan(a|d|t)|pdxg|pg(13|\-([1-8]|c))|phil|pire|pl(ay|uc)|pn\-2|po(ck|rt|se)|prox|psio|pt\-g|qa\-a|qc(07|12|21|32|60|\-[2-7]|i\-)|qtek|r380|r600|raks|rim9|ro(ve|zo)|s55\/|sa(ge|ma|mm|ms|ny|va)|sc(01|h\-|oo|p\-)|sdk\/|se(c(\-|0|1)|47|mc|nd|ri)|sgh\-|shar|sie(\-|m)|sk\-0|sl(45|id)|sm(al|ar|b3|it|t5)|so(ft|ny)|sp(01|h\-|v\-|v )|sy(01|mb)|t2(18|50)|t6(00|10|18)|ta(gt|lk)|tcl\-|tdg\-|tel(i|m)|tim\-|t\-mo|to(pl|sh)|ts(70|m\-|m3|m5)|tx\-9|up(\.b|g1|si)|utst|v400|v750|veri|vi(rg|te)|vk(40|5[0-3]|\-v)|vm40|voda|vulc|vx(52|53|60|61|70|80|81|83|85|98)|w3c(\-| )|webc|whit|wi(g |nc|nw)|wmlb|wonu|x700|yas\-|your|zeto|zte\-/i.test(a.substr(0,4)))&&(i=!0)}(navigator.userAgent||navigator.vendor||window.opera),i};$.fn.prepareTransition=function(){return this.each(function(){var n=$(this);n.one("TransitionEnd webkitTransitionEnd transitionend oTransitionEnd",function(){n.removeClass("is-transitioning")});var i=["transition-duration","-moz-transition-duration","-webkit-transition-duration","-o-transition-duration"],t=0;$.each(i,function(i,o){t||(t=parseFloat(n.css(o)))}),0!=t&&(n.addClass("is-transitioning"),n[0].offsetWidth)})};window.theme={};function onYouTubeIframeAPIReady(){theme.bnsliderVideo.loadVideos()}
theme.bnslider=(function(){this.$bnslider=null;var classes={wrapper:'bnslider-wrapper',bnslider:'bnslider',currentSlide:'slick-current',video:'bnslider-video',videoBackground:'bnslider-video--background',closeVideoBtn:'bnslider-video-control--close',pauseButton:'bnslider-pause',isPaused:'is-paused',animatedText:"[class^='bnslider-text'],[class*=' bnslider-text'],.btn-slider"};function bnslider(el){this.$bnslider=$(el);this.$wrapper=this.$bnslider.closest('.'+classes.wrapper);this.$pause=this.$wrapper.find('.'+classes.pauseButton);var $textBlock=$(classes.animatedText,$bnslider);$textBlock.each(function(){var $this=$(this),thisInlineStyle='';var thisStyle=$this.data();for(data in thisStyle){if(data=='fontcolor'){thisInlineStyle+='color:'+$this.data('fontcolor')+';'}
	...
	if(data=='fontline'){thisInlineStyle+='line-height:'+$this.data('fontline')+'px;'}
	...
	this.$bnslider.on('beforeChange',beforeChange.bind(this));this.$bnslider.on('init',bnsliderA11y.bind(this));this.settings={accessibility:!0,fade:!0,draggable:!0,touchThreshold:20,autoplay:this.$bnslider.data('autoplay'),autoplaySpeed:this.$bnslider.data('speed')};this.$bnslider.slick(this.settings);this.$pause.on('click',this.togglePause.bind(this))}
	function bnsliderA11y(event,obj){var $slider=obj.$slider;var $header=$('.page-header');var $list=obj.$list;var $wrapper=this.$wrapper;var autoplay=this.settings.autoplay;var $currentSlide=$slider.find('.'+classes.currentSlide);var $animatingElements=$currentSlide.find('[data-animation]');doAnimations($animatingElements);$slider.closest('.block').addClass('block--loaded');if($header.hasClass('transparent')){$header.addClass('visible')}
		$list.removeAttr('aria-live');$wrapper.on('focusin',function(evt){if(!$wrapper.has(evt.target).length){return}
	...
	function doAnimations(elements){var animationEndEvents='webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend';elements.each(function(){var $this=$(this);var $animationDelay=$this.data('delay')+'ms';var $animationType='animated '+$this.data('animation');$this.css({'animation-delay':$animationDelay,'-webkit-animation-delay':$animationDelay});$this.addClass($animationType).one(animationEndEvents,function(){$this.removeClass($animationType)});if($this.hasClass('animate')){$this.removeClass('animation')}})}
	function beforeChange(event,slick,currentSlide,nextSlide){var $slider=slick.$slider;var $currentSlide=$slider.find('.'+classes.currentSlide);var $nextSlide=$slider.find('.bnslider-slide[data-slick-index="'+nextSlide+'"]');if(isVideoInSlide($currentSlide)){var $currentVideo=$currentSlide.find('.'+classes.video);var currentVideoId=$currentVideo.attr('id');theme.bnsliderVideo.pauseVideo(currentVideoId);$currentVideo.attr('tabindex','-1')}
		if(isVideoInSlide($nextSlide)){var $video=$nextSlide.find('.'+classes.video);var videoId=$video.attr('id');var isBackground=$video.hasClass(classes.videoBackground);if(isBackground){theme.bnsliderVideo.playVideo(videoId)}else{$video.attr('tabindex','0')}}
	...
	function setAutoplaySupport(supported){var supportClass=supported?classes.supportsAutoplay:classes.supportsNoAutoplay;$(document.documentElement).addClass(supportClass);if(!supported){playOnClick=!0}
		autoplayCheckComplete=!0}
	function autoplayCheckFunction(player,$slide){player.playVideo();autoplayTest(player).then(function(){setAutoplaySupport(!0)}).fail(function(){setAutoplaySupport(!1);player.stopVideo()}).always(function(){autoplayCheckComplete=!0;$slide.removeClass(classes.loading)})}
	function autoplayTest(player){var deferred=$.Deferred();var wait;var timeout;wait=setInterval(function(){if(player.getCurrentTime()<=0){return}
		autoplayAvailable=!0;clearInterval(wait);clearTimeout(timeout);deferred.resolve()},500);timeout=setTimeout(function(){clearInterval(wait);deferred.reject()},4000);return deferred}
	function playOnClickCheck(){if(playOnClickChecked){return}
		if($(window).width()<750){playOnClick=!0}else if(window.mobileCheck()){playOnClick=!0}
		if(playOnClick){setAutoplaySupport(!1)}
	...
	return{init:init,loadVideos:loadVideos,loadVideo:loadVideo,playVideo:customPlayVideo,pauseVideo:pauseVideo,removeEvents:removeEvents}})();$(function(){theme.bnsliders={};$('.bnslider-video').each(function(){var $el=$(this);theme.bnsliderVideo.init($el);theme.bnsliderVideo.loadVideo($el.attr('id'))});$('.bnslider').each(function(){var $el=$(this);var bnslider="#"+$el.attr('id');theme.bnsliders[bnslider]=new theme.bnslider(bnslider)})})